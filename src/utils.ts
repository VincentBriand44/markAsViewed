...
export const mergeObjects = (objects: ItemParse[]): ItemParse => objects.reduce((acc, curr) => ({
    ...acc,
    ...curr,
    ...
    thumbnailUrl: Array.isArray(acc.thumbnailUrl) 
        ? [...acc.thumbnailUrl, ...(Array.isArray(curr.thumbnailUrl) ? curr.thumbnailUrl : [curr.thumbnailUrl])]
        : [acc.thumbnailUrl, ...(Array.isArray(curr.thumbnailUrl) ? curr.thumbnailUrl : [curr.thumbnailUrl])],
}))
